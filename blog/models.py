...
class Profile(models.Model):
    ...
    Profile_pic = models.FileField("Profile Pic",upload_to='uploads/',default='images/default.png',validators=[FileExtensionValidator(allowed_extensions=['jpg','png'],message='Please Upload The Fellowing Image Format jpg ord png')])
