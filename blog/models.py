...
class Profile(models.Model):
    ...
    Profile_pic = models.FileField("Profile Pic",upload_to='uploads/',default='https://social-blogers.nyc3.digitaloceanspaces.com/social-blogers/mediafiles/uploads/default.png',validators=[FileExtensionValidator(allowed_extensions=['jpg','png'],message='Please Upload The Fellowing Image Format jpg ord png')])
